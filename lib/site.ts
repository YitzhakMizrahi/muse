...
export const productSteps = [
  ...
  },
  {
    ...
    body: "Push the chosen direction toward bolder, calmer, more premium, or more experimental territory.",
  },
  {
    index: "04",
    title: "Keep the artifact",
    body: "Save a structured direction worth returning to, presenting, or building from.",
  },
];
